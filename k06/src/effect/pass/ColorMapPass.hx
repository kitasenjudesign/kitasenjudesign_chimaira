...
class ColorMapPass extends ShaderPass
{
	...
	public function new() 
	{
		...
		_textures.push( ImageUtils.loadTexture(Path.assets+ "grade/grade4.png") );
		_textures.push( ImageUtils.loadTexture(Path.assets + "grade/grade5.png") );
		_textures.push( ImageUtils.loadTexture(Path.assets + "grade/grade6.png") );
		_textures.push( ImageUtils.loadTexture(Path.assets + "grade/grade7.png") );
